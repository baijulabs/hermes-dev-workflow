...
# -> 2d966d0 [GH-103] (#112), c70c66f [GH-102] (#111)
...
Conclusion: #111 and #112 were pushed from `wt/t_765e2702` / `wt/t_79ce9f6f`
(checked out before #110 merged). Their squash-merges reverted the route.
...
# Verify #111/#112 routes still present (no regression):
...
(whole-file) — both reintroduce #111/#112's regression in the other direction.
